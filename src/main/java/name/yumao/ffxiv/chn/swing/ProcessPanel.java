...
public class ProcessPanel extends JFrame implements ActionListener {
    ...
    private static final String title = "FFXIV Localization Tool Lite";
    ...
    public JButton repackButton = new JButton("重新打包");
    ...
    public ProcessPanel() {
        ...
        setBounds((toolkit.getScreenSize().width - 300) / 2, (toolkit.getScreenSize().height - 140) / 2, 300, 140);
        setResizable(false);
        setLayout(null);
        ...
        add(titlePanel);
        titleLabel.setBounds(20, 0, 300, 30);
        ...
        langLableVal.setBounds(70, 45, 210, 30);
        ...
        repackButton.setBounds(180, 85, 100, 34);
        ...
        if (e.getSource() == repackButton) {
            ...
            if (!hasDataSqpack(inputPath)) {
                ...
                Thread unpackFileThread = new Thread(() -> {
                    unpackThread.run();
                    // 拆包結束後自動啟動打包
                    RepackThread repackThread = new RepackThread(outputPath, ProcessPanel.this);
